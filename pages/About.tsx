    ...
    <div className="bg-white">
      ...
      <div className="bg-zinc-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Our Hive Story</h1>
          <div className="h-1 w-20 bg-hive-red mb-6"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <div className="space-y-8 border-l-2 border-black pl-8 ml-4">
          ...
          <div className="bg-gray-50 p-8 rounded-xl border border-gray-200">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {admins.map((admin, idx) => (
                    <div key={idx} className="bg-white p-4 rounded-lg shadow-sm flex items-center space-x-4">
         ...
         <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="relative pt-6 max-w-3xl mx-auto">
               ...
               <div className="flex h-4 mb-4 overflow-hidden rounded bg-gray-700">
                  <div className="w-[90%] bg-hive-red transition-all duration-1000 hover:bg-red-500"></div>
